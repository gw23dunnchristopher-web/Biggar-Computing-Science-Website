    ...
    if (subQ.inputStyle === "nav-structure-higher") {
      return (
        <div className="mt-4">
          ...
          />
          <p className="text-xs text-neutral-500 mt-2">
            Create a hierarchical navigation structure: Use Page boxes for webpages, Connect lines for parent-child links, and Nav Area to highlight pages in the navigation bar.
          </p>
        </div>
      );
    }

      ...
      <header className="bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 px-6 py-4 sticky top-0 z-[200]">
        <div className="container mx-auto max-w-6xl flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={isEmailDialogOpen} onOpenChange={(open) => { setIsEmailDialogOpen(open); if (open) loadEmail(); }}>
              <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="text-neutral-600">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Set your email address to enable password reset functionality.</DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                  ...
                  <p className="text-sm text-neutral-500">This email will be used to send password reset links if you forget your password.</p>
                </div>
                <DialogFooter>

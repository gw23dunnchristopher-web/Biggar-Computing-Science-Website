...
app.use((req, res, next) => {
  ...
  const frameSrc = "frame-src 'self' https://trinket.io https://www.bhs-computing.co.uk https://bhs-computing.co.uk https://www.youtube-nocookie.com https://www.youtube.com https://onedrive.live.com https://*.sharepoint.com https://*.office.com https://*.officeapps.live.com";
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  // Fire-and-forget — server is already serving requests.
  import('./classwork-ai').then(({ prewarmLibreOfficeProfile }) => {
    prewarmLibreOfficeProfile().catch(() => {});
  }).catch(() => {});
});

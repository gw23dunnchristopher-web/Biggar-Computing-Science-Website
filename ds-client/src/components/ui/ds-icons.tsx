...
// ── Report/Form Design View icons ────────────────────────────────────────────
export const DsRptSelectIcon             = icon('select.svg');
export const DsRptLabelIcon              = icon('label.svg');
export const DsRptTextBoxIcon            = icon('textBox.svg');
export const DsRptButtonIcon             = icon('button.svg');
export const DsRptInsertImageIcon        = icon('insertImage.svg');
export const DsRptAttachmentIcon         = icon('attachement.svg');
export const DsRptLinkIcon              = icon('link.svg');
export const DsRptLineIcon              = icon('line.svg');
export const DsRptRectangleIcon          = icon('rectangle.svg');
export const DsRptCheckBoxIcon           = icon('checkBox.svg');
export const DsRptOptionButtonIcon       = icon('optionButton.svg');
export const DsRptToggleButtonIcon       = icon('toggleButton.svg');
export const DsRptComboBoxIcon           = icon('comboBox.svg');
export const DsRptListBoxIcon            = icon('listBox.svg');
export const DsRptSubFormSubReportIcon   = icon('subForm-subReport.svg');
export const DsRptInsertModernChartIcon  = icon('InsertModernChart.svg');
export const DsRptInsertPageBreakIcon    = icon('insertPageBreak.svg');
export const DsRptOptionGroupIcon        = icon('optionGroup.svg');
export const DsRptBoundObjectFrameIcon   = icon('boundObjectFrame.svg');
export const DsRptUnboundObjectFrameIcon = icon('unboundObjectFrame.svg');
export const DsRptTabControlIcon         = icon('tabControl.svg');
export const DsRptEdgeBrowserIcon        = icon('edgeBrowserControlsvg.svg');
export const DsRptThemesIcon             = icon('themes.svg');
export const DsRptColorsIcon             = icon('colors.svg');
export const DsRptFontsIcon              = icon('fontssvg.svg');
export const DsRptGroupSortIcon          = icon('group&sort.svg');
export const DsRptTotalsIcon             = icon('totals.svg');
export const DsRptHideDetailsIcon        = icon('hideDetails.svg');
export const DsRptLogoIcon              = icon('logo.svg');
export const DsRptTitleIcon             = icon('title.svg');
export const DsRptDateAndTimeIcon        = icon('dateAndTime.svg');
export const DsRptAddExistingFieldsIcon  = icon('addExistingFields.svg');
export const DsRptPropertySheetIcon      = icon('propertySheet.svg');
export const DsRptTabOrderIcon           = icon('tabOrder.svg');
export const DsRptChartSettingsIcon      = icon('chartSettings.svg');

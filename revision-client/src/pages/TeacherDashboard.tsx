    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <main className="container mx-auto max-w-6xl p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="cursor-pointer hover:shadow-md transition-shadow border-sky-300 dark:border-sky-700 bg-sky-100/80 dark:bg-sky-950/30" onClick={() => setLocation("/teacher/assignments")} data-testid="link-assignment-manager">
            <CardContent className="p-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Create coursework assignments with sections and parts</p>
              </div>
            </CardContent>
          </Card>
          <Card className="cursor-pointer hover:shadow-md transition-shadow border-violet-300 dark:border-violet-700 bg-violet-100/80 dark:bg-violet-950/30" onClick={() => setLocation("/teacher/additional-exams")} data-testid="link-additional-exams">
            <CardContent className="p-4 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 dark:text-white leading-tight">Additional Exams</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Create and manage teacher-authored exam papers</p>
              </div>
            </CardContent>
          </Card>
          <Card className="cursor-pointer hover:shadow-md transition-shadow border-amber-300 dark:border-amber-700 bg-amber-100/80 dark:bg-amber-950/30" onClick={() => setLocation("/teacher/progress")} data-testid="link-student-progress">
            <CardContent className="p-4 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-neutral-900 dark:text-white leading-tight">Student Progress</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">View class performance and exam analytics</p>
              </div>
            </CardContent>
          </Card>
